    ...
    <DashboardShell>
      ...
      <div className="flex items-start gap-4 pb-8 border-b border-[#1A1A1A]">
        <div className="h-10 w-10 rounded-xl bg-[#111111] border border-[#1A1A1A] flex items-center justify-center shrink-0">
          <Settings2 className="h-5 w-5 text-[#FF5A1F]" />
        </div>
        <div>
          <h1 className="text-2xl font-bold text-[#F2F2F2] tracking-tight">System Center</h1>
      ...
      <div className="mt-6 p-6 rounded-2xl bg-[#111111] border border-[#1A1A1A] border-dashed">
        ...
        <p className="text-xs text-[#5A5A5A] mt-1.5 leading-relaxed max-w-lg">
          Inline-save settings (no page reloads), plugin marketplace with enable/disable toggles, 
          API key manager with scoped permissions, user management, and backup snapshot controls.
        </p>
      </div>
    </DashboardShell>
  )
